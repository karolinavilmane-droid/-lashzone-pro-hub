    ...
    >
        ...
        >
          ...
          {selectedId && (
            <div
              ...
              style={{ background: 'rgba(244,162,97,0.10)', border: '1px solid rgba(244,162,97,0.22)' }}
            >
              <div className="w-1.5 h-1.5 rounded-full bg-brand-primary" />
              <span className="text-[10px] font-black text-[#C98] uppercase tracking-[0.2em]">
                Active Section
              </span>
            </div>
          )}
      ...
      <div className="flex items-center gap-2 md:gap-6">
        ...
        <div
          ...
          style={{ background: 'rgba(244,162,97,0.06)', border: '1px solid rgba(244,162,97,0.20)', boxShadow: 'var(--shadow-brand-sm)' }}
