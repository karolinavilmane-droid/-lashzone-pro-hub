...
export default function DashboardView({ onConsultationAction }: { onConsultationAction: () => void }) {
  return (
    <motion.div
      ...
      className="p-4 md:p-8 max-w-6xl mx-auto space-y-8 md:space-y-12"
    >
      {/* Header */}
      <div className="text-center space-y-6">
        ...
        >
          <h1 className="text-3xl md:text-5xl font-serif font-bold text-brand-primary-dark tracking-tight mb-4">
            LashZone Consultation Hub
          </h1>
          <p className="text-base md:text-xl text-[#333] font-light max-w-2xl mx-auto leading-relaxed">
        ...
        >
          <button
            ...
            className="px-6 md:px-8 py-3 md:py-4 bg-brand-primary text-white rounded-xl font-semibold hover:bg-brand-primary-dark transition-all shadow-lg hover:shadow-xl flex items-center gap-3"
          >
            Browse Resources
            <ArrowRight size={20} />
          </button>
      ...
      >
                <div className="bg-white border border-brand-border-light rounded-xl p-4 md:p-6 shadow-sm hover:shadow-md transition-shadow">
          <div className="w-10 h-10 md:w-12 md:h-12 bg-brand-primary-light rounded-lg flex items-center justify-center mb-4">
          ...
          >
            View Resource →
                ...
                <div className="bg-white border border-brand-border-light rounded-xl p-4 md:p-6 shadow-sm hover:shadow-md transition-shadow">
          <div className="w-10 h-10 md:w-12 md:h-12 bg-brand-accent/10 rounded-lg flex items-center justify-center mb-4">
