    ...
    >
      ...
      <div className="text-center space-y-6">
        ...
        >
          ...
          <p className="text-xl text-brand-ink-deep/70 font-light max-w-2xl mx-auto leading-relaxed">
      ...
      >
        <div className="bg-white border border-brand-border-light rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow">
          ...
          <h3 className="font-semibold text-brand-primary-dark mb-2">Free Guide</h3>
          <p className="text-sm text-brand-ink-deep/60 mb-4">Get started with our introductory consultation guide.</p>
          <button
            onClick={onConsultationAction}
        ...
        <div className="bg-white border border-brand-border-light rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow">
          ...
          <h3 className="font-semibold text-brand-primary-dark mb-2">Checklists</h3>
          <p className="text-sm text-brand-ink-deep/60 mb-4">Essential preparation checklists for consultations.</p>
          <button
            onClick={onConsultationAction}
            className="text-brand-primary font-medium text-sm hover:text-brand-primary-dark transition-colors"
          >
        ...
        <div className="bg-white border border-brand-border-light rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow">
          ...
          <h3 className="font-semibold text-brand-primary-dark mb-2">Step-by-Step</h3>
          <p className="text-sm text-brand-ink-deep/60 mb-4">Detailed consultation framework guides.</p>
          <button
            onClick={onConsultationAction}
            className="text-brand-primary font-medium text-sm hover:text-brand-primary-dark transition-colors"
          >
        ...
        <div className="bg-white border border-brand-border-light rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow">
          ...
          <h3 className="font-semibold text-brand-primary-dark mb-2">Forms</h3>
          <p className="text-sm text-brand-ink-deep/60 mb-4">Professional consultation form templates.</p>
          <button
            onClick={onConsultationAction}
            className="text-brand-primary font-medium text-sm hover:text-brand-primary-dark transition-colors"
          >
      ...
      <motion.div
        ...
        className="text-center text-brand-ink-deep/50 text-sm"
      >
